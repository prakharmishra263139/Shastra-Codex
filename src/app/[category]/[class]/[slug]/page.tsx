              ...
              {entry.operators.map((service) => {
                ...
                return (
                  <span
                    ...
                    style={
                      force
                        ? ({ "--tone": force.tone } as React.CSSProperties)
                        : undefined
                    }
                  ...
                  {candidates.map((other) => (
                    <li key={other.slug}>
                      <Link
                        ...
                        className="group block rounded-lg border border-rule bg-surface px-4 py-3 transition-colors hover:border-accent"
                      >
                        <span className="font-display text-[14.5px] font-semibold transition-colors group-hover:text-accent">
                          {other.name}
                        </span>
